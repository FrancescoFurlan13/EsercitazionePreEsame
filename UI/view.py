...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddLoca = ft.Dropdown(label="localizzazione", width=400)
        self.btn_stats = ft.ElevatedButton(text="Statistiche", on_click=self._controller.handle_stats)

        row2 = ft.Row([self.ddLoca, self.btn_stats],
                      alignment=ft.MainAxisAlignment.CENTER)
